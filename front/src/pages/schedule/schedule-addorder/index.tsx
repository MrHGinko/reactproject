...
const ScheduleAddOrder: React.FC<{}> = function ScheduleAddOrder(){
  ...
  return (
    <div className="wrap">
      ...
      <CommonTable status={status} data={data} columns={columns} rowSelection={rowSelection}/>
      {(addStatus === true) ? 
        <>
          ...
          <div className="addTable">
            <p className="addTitle">
              新增/编辑补单
              <Icon className="close" type="close" onClick={()=>{
                setAddStatus(false);
              }}/>
            </p>
            <div className="content">
              <button className="selectCar" onClick={()=>{
                selectCar(true);
              }}>选择车辆</button>
              <div className="allColumn">
                <div className="column-one">
             ...
             <button className="addPassenger" onClick={()=>{
               addPassengerAction(true);
             }}>添加乘客</button>
            </div>
            <Table columns={passengerColumns} 
           dataSource={passengerData} className="passengerList"/>
...

        {
          addPassengerStatus ? 
          <>
          <div className="addPassengerWrap">
          </div>
